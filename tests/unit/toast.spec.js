  ...
  describe('Toast.vue', () => {
    ...
    it('should render correct contents - no type', () => {
      ...
      expect(vm.$el.className)
        .to.equal('wy-popup wy-toast')
      expect(vm.$el.querySelector('.wy-loading'))
        .not.to.be.null
    ...
    it('should render correct contents - with type', () => {
      ...
      vm.show()
      expect(vm.$el.querySelector('.wy-toast-icon').className)
        .to.include('icon-error')
      expect(vm.$el.querySelector('.wy-toast-tip').textContent)
    ...
    it('should render correct contents - with type txt', () => {
      ...
      expect(vm.$el.className)
        .to.equal('wy-popup wy-toast')
      expect(vm.$el.querySelector('.wy-toast-icon'))
        .to.be.null
      expect(vm.$el.querySelector('.wy-toast-tip').textContent)
        .to.equal('toast content')
      return new Promise((resolve) => {
    ...
    it('$createToast API', (done) => {
      ...
      setTimeout(() => {
        expect(ins.$el.className)
          .to.include('my-toast')
        expect(ins.$el.querySelector('.wy-toast-tip').textContent)
